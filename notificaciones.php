...
<strong><p class="mb-0 text-uppercase" style="font-size:22px;">&nbsp;&nbsp;&nbsp;DATOS DE COLABORADORES </p> </strong> </div> 	    
...
<img src="includes/contraertodos2.png" id="ocultartodos" style="cursor:pointer;"/>&nbsp;<?php echo  isset($NOMBRE_1)?' || '.$NOMBRE_1:'';?>&nbsp;
<?php echo  isset($APELLIDO_PATERNO)?' '.$APELLIDO_PATERNO:'';?>	 </p> </strong> </div>
